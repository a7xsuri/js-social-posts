...
function setLike () { 
    ...
    let LikeNumber = document.getElementById(`like-counter-${postId}`).innerHTML;
    if (!Like.includes(posts[postId - 1])) {
        this.style.color = "red";
        LikeNumber++;
        Like.push(posts[postId - 1])
    }
    else {
        this.style.color = "black";
        LikeNumber--;
        let remove = Like.splice(postId - 1, 0);
        Like = remove;
    }
    document.getElementById(`like-counter-${postId}`).innerHTML = LikeNumber;
}
